      ...
      {inquiryStatus === "new" ? (
        <Button
          ...
          loading={
            ...
            updateInquiryStatus.variables?.status === "viewed"
          }
          onClick={() => void handleStatusUpdate("viewed")}
        >
          Mark viewed
        </Button>
      ) : null}
...
export function ReceivedInquiriesList({
  ...
  return (
    <div className="space-y-4">
      {inquiryDirectory.items.map(({ inquiry, property, propertyImage, contact }) => (
        <div
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    >
                      {formatInquiryStatus(inquiry.inquiry_status)}
                    </span>
