...
export default async function PropertiesPage({
  ...
  return (
    <>
      ...
      <div className="-mx-4 sm:-mx-6 lg:-mx-8 -mt-8 bg-linear-to-br from-white via-sky-50 to-blue-100 pb-6 sm:pb-8 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950">
